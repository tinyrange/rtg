...
// using a mark-and-sweep reachability analysis starting from the resolved
// entrypoint, init functions, and backend-implicit roots.
func EliminateDeadFunctions(irmod *IRModule) {
	...
	// Root set: program entrypoint
	worklist = dceAddRoot(EntryFuncName(irmod), funcIndex, reachable, worklist)

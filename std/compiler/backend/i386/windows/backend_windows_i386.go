...
func compilePanicWin386(g *core.CodeGen) {
	...
	g.PushR32(core.REG32_ESI)
	g.PushR32(core.REG32_EBX)
	g.LoadMem32(core.REG32_ESI, core.REG32_EAX, 0)
	g.LoadMem32(core.REG32_EBX, core.REG32_EAX, 4)

	g.EmitMovRegImm32(core.REG32_EAX, 0xFFFFFFF4)
	g.PushR32(core.REG32_EAX)
	g.EmitCallIAT("GetStdHandle")
	g.MovRR32(core.REG32_ECX, core.REG32_EAX)

	g.SubRI32(core.REG32_ESP, 4)
	g.MovRR32(core.REG32_EDX, core.REG32_ESP)

	pushImm32(g, 0)
	g.PushR32(core.REG32_EDX)
	g.PushR32(core.REG32_EBX)
	g.PushR32(core.REG32_ESI)
	...
	g.MovRR32(core.REG32_ESI, core.REG32_ESP)
	...
	g.PushR32(core.REG32_ECX)
	g.EmitCallIAT("WriteFile")
	g.AddRI32(core.REG32_ESP, 8)

	g.PopR32(core.REG32_EBX)
	g.PopR32(core.REG32_ESI)
